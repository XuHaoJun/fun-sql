...
Why use Declarative language? Imperative language with good static analysis or use general-purpose logic programming language([Prolog](https://en.wikipedia.org/wiki/Prolog)) are not enough?
